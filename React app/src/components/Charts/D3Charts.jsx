...
const D3Charts = () => {
  ...
  useEffect(() => {
    const url = 'http://127.0.0.1:5000/d3';
    ...
    <div className="mainComponent">
      <div className="grpahDiv">
        <Typography variant="h5" gutterBottom>
          A Line Chart to plot the issues for D3/D3 Repository
        </Typography>
      ...
      <div>
        <Typography variant="h5" gutterBottom>
          A Bar Chart to plot the issues created for every month for D3/D3
          Repository
        </Typography>
        <Grid container justifyContent="center" spacing={2}>
          <BarChart
      ...
      <div>
        <Typography variant="h5" gutterBottom>
          A Bar Chart to plot the issues closed for every Week for D3/D3
          Repository
        </Typography>
        <Grid container justifyContent="center" spacing={2}>
          <BarChart
