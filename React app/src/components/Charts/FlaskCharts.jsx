...
const FlaskCharts = () => {
  ...
  useEffect(() => {
    const url = 'http://127.0.0.1:5000/flask';
    ...
    <div className="mainComponent">
      <div className="grpahDiv">
        <Typography variant="h5" gutterBottom>
          A Line Chart to plot the issues for Pallets/Flask Repository
        </Typography>
      ...
      <div>
        <Typography variant="h5" gutterBottom>
          A Bar Chart to plot the issues closed for every Week for Pallets/Flask
          Repository
        </Typography>
        <Grid container justifyContent="center" spacing={2}>
          <BarChart
