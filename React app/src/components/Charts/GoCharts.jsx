    ...
    <div className="mainComponent">
      <div className="grpahDiv">
        <Typography variant="h5" gutterBottom>
          A Line Chart to plot the issues for Golang/Go Repository
        </Typography>
      ...
      <div>
        <Typography variant="h5" gutterBottom>
          A Bar Chart to plot the issues created for every month for Golang/Go
          Repository
        </Typography>
        <Grid container justifyContent="center" spacing={2}>
          <BarChart
      ...
      <div>
        <Typography variant="h5" gutterBottom>
          A Bar Chart to plot the issues closed for every Week for Golang/Go
          Repository
        </Typography>
        <Grid container justifyContent="center" spacing={2}>
          <BarChart
