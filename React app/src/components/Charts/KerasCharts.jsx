...
const KerasCharts = () => {
  ...
  useEffect(() => {
    const url = 'http://127.0.0.1:5000/keras';
    ...
    <div className="mainComponent">
      <div className="grpahDiv">
        <Typography variant="h5" gutterBottom>
          A Line Chart to plot the issues for Keras-Team/Keras Repository
        </Typography>
